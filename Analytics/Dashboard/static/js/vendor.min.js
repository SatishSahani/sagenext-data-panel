...
(function () {
  ...
  for (
    _ = {
      ...
      b = function () {
        for (
          var t,
            ...
            i,
            n = arguments[0],
            s = 2 <= arguments.length ? $.call(arguments, 1) : [],
            o = 0,
            r = s.length;
          o < r;
          o++
      ...
      f = function (t) {
        for (var e, i, n = (e = 0), s = 0, o = t.length; s < o; s++)
          (i = t[s]), (n += Math.abs(i)), e++;
        return n / e;
      },
      w = function (t, e) {
        var i, n;
      ...
      Q.prototype.off = function (t, e) {
        ...
        if (null != (null != (n = this.bindings) ? n[t] : void 0)) {
          ...
          for (i = 0, s = []; i < this.bindings[t].length; )
            this.bindings[t][i].handler === e
              ? s.push(this.bindings[t].splice(i, 1))
              : s.push(i++);
          return s;
        }
      },
      Q.prototype.trigger = function () {
        ...
        if (null != (n = this.bindings) && n[r]) {
          for (i = 0, o = []; i < this.bindings[r].length; )
            (e = (s = this.bindings[r][i]).handler),
              (t = s.ctx),
              (s = s.once),
              e.apply(null != t ? t : this, a),
              s ? o.push(this.bindings[r].splice(i, 1)) : o.push(i++);
          return o;
        }
      },
      U = Q,
      ...
      window.Pace = r,
      b(r, U.prototype),
      E = r.options = b({}, _, window.paceOptions, w()),
      j = 0,
      q = (Y = ["ajax", "document", "eventLag", "elements"]).length;
    j < q;
    j++
  )
    !0 === E[(N = Y[j])] && (E[N] = _[N]);
    ...
    et.__super__.constructor.apply(this, arguments),
      (t = function (t) {
        ...
        return (t.open = function (n, s, o) {
          return (
            O(n) && e.trigger("request", { type: n, url: s, request: t }),
            i.apply(t, arguments)
          );
        });
      }),
  ...
  V(J, (U = Error)),
    ...
    (Z.prototype.render = function () {
      ...
      for (
        t = this.getElement(),
          ...
          s = 0,
          o = (a = ["webkitTransform", "msTransform", "transform"]).length;
        s < o;
        s++
      )
        (e = a[s]), (t.children[0].style[e] = n);
      return (
        (!this.lastRenderedProgress ||
          ...
          100 <= this.progress
            ? (i = "99")
            : ((i = this.progress < 10 ? "0" : ""), (i += 0 | this.progress)),
    ...
    (tt.prototype.trigger = function (t, e) {
      ...
      if (null != this.bindings[t]) {
        for (r = [], n = 0, s = (o = this.bindings[t]).length; n < s; n++)
          (i = o[n]), r.push(i.call(this, e));
        return r;
      }
    }),
    (tt.prototype.on = function (t, e) {
      var i;
      return (
        null == (i = this.bindings)[t] && (i[t] = []), this.bindings[t].push(e)
      );
    }),
    (s = tt),
    ...
    (r.ignore = function () {
      ...
      return k.unshift("ignore"), (e = t.apply(null, e)), k.shift(), e;
    }),
    (r.track = function () {
      var t = arguments[0],
        e = 2 <= arguments.length ? $.call(arguments, 1) : [];
      return k.unshift("track"), (e = t.apply(null, e)), k.shift(), e;
    }),
    (O = function (t) {
      if ((null == t && (t = "GET"), "track" === k[0])) return "force";
      if (!k.length && E.ajax) {
        if ("socket" === t && E.ajax.trackWebSockets) return !0;
        if (((t = t.toUpperCase()), 0 <= G.call(E.ajax.trackMethods, t)))
          return !0;
      }
      return !1;
    }),
    ...
    (x = function () {
      ...
      var i,
        ...
        o = t.url;
      if (!M(o))
        return r.running || (!1 === E.restartOnRequestAfter && "force" !== O(n))
          ? void 0
          : ((i = arguments),
            "boolean" == typeof (o = E.restartOnRequestAfter || 0) && (o = 0),
            setTimeout(function () {
              var t,
                o,
                a,
                ...
                h =
                  "socket" === n
                    ? s.readyState < 1
                    : 0 < (h = s.readyState) && h < 4;
              if (h) {
                for (
                  r.restart(), l = [], t = 0, o = (a = r.sources).length;
                  t < o;
                  t++
                ) {
    ...
    (it.prototype.watch = function (t) {
      ...
      if (!M(t))
        return (
          (i = new ("socket" === e ? c : u)(i, this.complete)),
      ...
      if (((this.progress = 0), null != window.ProgressEvent))
        ...
        (s = t.onreadystatechange),
          (t.onreadystatechange = function () {
            var i;
            return (
              0 === (i = t.readyState) || 4 === i
                ? (e(r), (r.progress = 100))
                : 3 === t.readyState && (r.progress = 50),
    ...
    (rt.prototype.tick = function (t, e) {
      return (
        100 <= (e = null == e ? A(this.source, "progress") : e) &&
          (this.done = !0),
        e === this.last
        ...
        (e = 1 - Math.pow(this.progress / 100, E.easeFactor)),
    ...
    null != window.history.pushState &&
      ...
      (window.history.pushState = function () {
        return C(), B.apply(window.history, arguments);
      })),
    ...
    (l = { ajax: e, elements: w, document: U, eventLag: V }),
    (T = function () {
      var t, e, n, s, o, a, c, u;
      for (
        r.sources = L = [],
          e = 0,
          s = (a = ["ajax", "elements", "document", "eventLag"]).length;
        e < s;
        e++
      )
        !1 !== E[(t = a[e])] && L.push(new l[t](E[t]));
      for (
        n = 0, o = (u = null != (c = E.extraSources) ? c : []).length;
        n < o;
        n++
      )
        (N = u[n]), L.push(new N(E));
    ...
    (r.stop = function () {
      return (
        ...
        g.destroy(),
        (m = !0),
        null != p && ("function" == typeof v && v(p), (p = null)),
        T()
      );
    }),
    (r.restart = function () {
          ...
          for (
            ...
            for (
              N = L[b],
                l = null != P[b] ? P[b] : (P[b] = []),
                o = d = 0,
                p = (s = null != (f = N.elements) ? f : [N]).length;
              d < p;
              o = ++d
            )
              (a = s[o]),
                (_ &= (a = null != l[o] ? l[o] : (l[o] = new h(a))).done),
                a.done || (v++, (c += a.tick(e)));
          return (
            (n = c / v),
            g.update(H.tick(e, n)),
            g.done() || _ || m
              ? (g.update(100),
                ...
                }, Math.max(E.ghostTime, Math.max(E.minTime - (D() - t), 0))))
              : i()
          );
        }))
      );
  ...
  (function (t, e) {
            ...
            if (null != (t = arguments[a]))
              for (e in t)
                (n = t[e]),
                  "__proto__" !== e &&
                    r !== n &&
                    (h && n && (w.isPlainObject(n) || (s = Array.isArray(n)))
                      ? ((i = r[e]),
                        (o =
                          s && !Array.isArray(i)
                            ? []
        ...
        if (!s && (d(e), (e = e || p), g)) {
          ...
          if (
            ...
            if (((v = t), (_ = e), 1 === w && (X.test(t) || Y.test(t)))) {
              for (
                ((_ = (tt.test(t) && vt(e.parentNode)) || e) === e &&
                  i.scope) ||
                  ((c = e.getAttribute("id"))
                    ? (c = c.replace(nt, st))
        ...
        return (
          ...
          ht(function (o, r, a, l) {
            var h,
              ...
              v = i ? (s || (o ? t : f || n) ? [] : r) : m;
            if ((i && i(m, v, a, l), n))
              for (h = xt(v, p), n(h, [], a, l), c = h.length; c--; )
                (u = h[c]) && (v[p[c]] = !(m[p[c]] = u));
            if (o) {
              if (s || t) {
                if (s) {
              ...
              (m = D(
                ...
                (c = function (t, e, i, r, c) {
                  ...
                  for (
                    ...
                    if (l && u) {
                      for (
                        f = 0, e || u.ownerDocument == p || (d(u), (i = !g));
                        (m = s[f++]);
          ...
          function (t, e, i, s) {
            ...
            if (((i = i || []), 1 === p.length)) {
              if (
                ...
                if (
                  !(e = (n.find.ID(h.matches[0].replace(et, it), e) || [])[0])
                )
                  return i;
              ...
              for (
                ...
                if (
                  ...
                  if ((l.splice(o, 1), !(t = s.length && bt(l))))
    ...
    (w.filter = function (t, e, i) {
      ...
      w.fn.extend({
        ...
        is: function (t) {
          return !!A(
            this,
            "string" == typeof t && D.test(t) ? w(t) : t || [],
            !1
          ).length;
        },
      });
      ...
      if (((i = i || I), "string" == typeof t)) {
        ...
        if (n[1]) {
          if (
            ...
            S.test(n[1]) && w.isPlainObject(e))
          )
            for (n in e) f(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
          return this;
        }
        return (
          (s = m.getElementById(n[2])) && ((this[0] = s), (this.length = 1)),
          this
        );
      }
      return t.nodeType
        ...
        function (t, e) {
          w.fn[t] = function (i, n) {
            ...
            return (
              ...
              1 < this.length &&
                (O[t] || w.uniqueSort(s), M.test(t) && s.reverse()),
              this.pushStack(s)
            );
          };
        }
    ...
    (w.Callbacks = function (t) {
      ...
      w.extend({
          ...
          var i = [
            ...
            s = {
              ...
              then: function (e, n, s) {
                      ...
                      h = function () {
                        ...
                        if (!(e < o)) {
                          ...
                          (h =
                            ...
                            f(h)
                              ? s
                                ? h.call(t, r(o, i, H, s), r(o, i, W, s))
                                : (o++,
                                  h.call(
                                    t,
                                    r(o, i, H, s),
                                    r(o, i, W, s),
                                    r(o, i, H, i.notifyWith)
                                  ))
                              : (n !== H && ((a = void 0), (l = [t])),
                                (s || i.resolveWith)(a, l));
                        }
                ...
                return w
                  .Deferred(function (t) {
                    i[0][3].add(r(0, t, f(s) ? s : H, t.notifyWith)),
                      i[1][3].add(r(0, t, f(e) ? e : H)),
                      i[2][3].add(r(0, t, f(n) ? n : W));
                  })
                  .promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          ...
          if (
            e <= 1 &&
            (R(t, r.done(a(i)).resolve, r.reject, !e),
      ...
      w.fn.extend({
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((s = G.get(o)), 1 === o.nodeType && !V.get(o, "hasDataAttrs"))
            ) {
              for (i = r.length; i--; )
                r[i] &&
              ...
              "" === n.style.display &&
                ...
                (h[c] =
                  ...
                  (l = lt[a]) ||
                    ...
                    "none" === l && (l = "block"),
                    (lt[a] = l)))))
            : "none" !== i && ((h[c] = "none"), V.set(n, "display", i)));
    ...
    function bt(t, e, i, n, s) {
      ...
      for (u.textContent = "", p = 0; (o = d[p++]); )
        if (n && -1 < w.inArray(o, n)) s && s.push(o);
          ...
          ((h = st(o)), (r = mt(u.appendChild(o), "script")), h && vt(r), i)
        )
    ...
    (w.event = {
          ...
          for (h = (e = (e || "").match(L) || [""]).length; h--; )
            if (
              ...
              r &&
                ...
                delete l[p]);
            } else for (p in l) w.event.remove(t, p + e[h], i, n, !0);
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            r = w.event.handlers.call(this, l, h), e = 0;
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && E(e, "input") && Tt(e, "click", wt),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && E(e, "input") && Tt(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
    ...
    function Ot(t, e, i, n) {
      ...
      var s,
        ...
        m = e[0],
        v = f(m);
      if (v || (1 < d && "string" == typeof m && !p.checkClone && Et.test(m)))
        return t.each(function (s) {
          var o = t.eq(s);
          v && (e[0] = m.call(this, s, o.html())), Ot(o, e, i, n);
        });
      if (
        d &&
        ((r = (s = bt(e, t[0].ownerDocument, !1, t, n)).firstChild),
        1 === s.childNodes.length && (s = r),
        r || n)
      ) {
        for (l = (a = w.map(mt(s, "script"), It)).length; u < d; u++)
          (h = s),
            u !== g &&
              ((h = w.clone(h, !0, !0)), l && w.merge(a, mt(h, "script"))),
            i.call(t[u], h, u);
        if (l)
          for (
            c = a[a.length - 1].ownerDocument, w.map(a, Pt), u = 0;
            u < l;
            u++
          )
            (h = a[u]),
              ft.test(h.type || "") &&
                ...
                (h.src && "module" !== (h.type || "").toLowerCase()
                  ...
                  : _(h.textContent.replace(St, ""), h, c));
      }
      return t;
    }
    function Nt(t, e, i) {
      ...
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (r = mt(c), n = 0, s = (o = mt(t)).length; n < s; n++)
            (a = o[n]),
              "input" === (h = (l = r[n]).nodeName.toLowerCase()) &&
              dt.test(a.type)
                ? (l.checked = a.checked)
                : ("input" !== h && "textarea" !== h) ||
        ...
        if (e)
          if (i)
            for (
              o = o || mt(t), r = r || mt(c), n = 0, s = o.length;
              n < s;
              n++
            )
              Mt(o[n], r[n]);
        ...
        return (
          0 < (r = mt(c, "script")).length && vt(r, !u && mt(t, "script")), c
        );
      },
      cleanData: function (t) {
        for (
          var e, i, n, s = w.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        )
          if ($(i)) {
      ...
      function e() {
        if (c) {
          (h.style.cssText =
            ...
            nt.appendChild(h).appendChild(c);
      ...
      return (
        ...
        (t in qt
          ...
          : (Bt[t] =
              (function (t) {
                for (
                  var e = t[0].toUpperCase() + t.slice(1), i = Ft.length;
                  i--;
    ...
    function Qt(t, e, i) {
      ...
      return (
        ((!p.boxSizingReliable() && s) ||
          ...
          (o = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) +
          Gt(t, e, i || (s ? "border" : "content"), o, n, r) +
          "px"
      );
    }
    ...
    w.extend({
      ...
      w.each(["height", "width"], function (t, e) {
        w.cssHooks[e] = {
          get: function (t, i, n) {
            if (i)
              return !Xt.test(w.css(t, "display")) ||
        ...
        _default: {
          ...
          set: function (t) {
            w.fx.step[t.prop]
              ? w.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!w.cssHooks[t.prop] && null == t.elem.style[Yt(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    function he(t, e, i) {
      ...
      for (
        ...
        if ((n = he.prefilters[o].call(h, t, c, h.opts)))
          return (
            f(n.stop) &&
              (w._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)),
            n
          );
      return (
        w.map(c, le, h),
        ...
        w.fx.timer(w.extend(l, { elem: t, anim: h, queue: h.opts.queue })),
        h
      );
    }
        ...
        function (t, e, i) {
          ...
          if ((l = !w.isEmptyObject(e)) || !w.isEmptyObject(p))
            for (n in (u &&
              ...
              null == (h = m && m.display) && (h = V.get(t, "display")),
            ...
            p))
              l ||
                (m
                  ...
                  : (m = V.access(t, "fxshow", { display: h })),
                o && (m.hidden = !g),
                g && ht([t], !0),
                d.done(function () {
                  for (n in (g || ht([t]), V.remove(t, "fxshow"), p))
                    w.style(t, n, p[n]);
                })),
                (l = le(g ? m[n] : 0, n, d)),
                n in m ||
            ...
            return void 0 === t.getAttribute
              ...
              : ((1 === o && w.isXMLDoc(t)) ||
                  (s =
                    ...
                    (w.expr.match.bool.test(e) ? ce : void 0)),
                void 0 !== i
                  ? null === i
    ...
    w.extend(w.event, {
      trigger: function (e, i, n, s) {
        ...
        if (
          ...
          3 !== n.nodeType &&
            8 !== n.nodeType &&
            !_e.test(_ + w.event.triggered) &&
            (-1 < _.indexOf(".") &&
              ((_ = (b = _.split(".")).shift()), b.sort()),
            (h = _.indexOf(":") < 0 && "on" + _),
            ((e = e[w.expando]
              ? e
              : new w.Event(_, "object" == typeof e && e)).isTrigger = s
              ? 2
              : 3),
            (e.namespace = b.join(".")),
          ...
          if (!s && !d.noBubble && !g(n)) {
            for (
              l = d.delegateType || _, _e.test(l + _) || (r = r.parentNode);
              r;
              r = r.parentNode
            )
              v.push(r), (a = r);
          ...
          for (o = 0; (r = v[o++]) && !e.isPropagationStopped(); )
            (p = r),
              ...
              (u =
                (V.get(r, "events") || Object.create(null))[e.type] &&
                V.get(r, "handle")) && u.apply(r, i),
              (u = h && r[h]) &&
                u.apply &&
                $(r) &&
          ...
          return (
            ...
            s ||
              ...
              (h &&
                ...
                ((a = n[h]) && (n[h] = null),
                (w.event.triggered = _),
                e.isPropagationStopped() && p.addEventListener(_, be),
                n[_](),
                e.isPropagationStopped() && p.removeEventListener(_, be),
        ...
        w.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
          ...
          w.event.special[e] = {
            ...
            teardown: function () {
              ...
              s
                ? V.access(n, e, s)
                : (n.removeEventListener(t, i, !0), V.remove(n, e));
            },
          };
        });
    var ye = t.location,
        ...
        ajax: function (e, i) {
          ...
          p.hasContent
            ? p.data &&
              ...
              (p.data = p.data.replace(Se, "+"))
            : ((d = p.url.slice(s.length)),
              p.data &&
                (p.processData || "string" == typeof p.data) &&
                ((s += (xe.test(s) ? "&" : "?") + p.data), delete p.data),
              !1 === p.cache &&
                ((s = s.replace(Ie, "$1")),
                (d = (xe.test(s) ? "&" : "?") + "_=" + we.guid++ + d)),
              (p.url = s + d)),
          p.ifModified &&
            (w.lastModified[s] &&
          ...
          if (p.beforeSend && (!1 === p.beforeSend.call(f, k, p) || h))
            return k.abort();
          if (
            ((C = "abort"),
            _.add(p.complete),
            ...
            if (((k.readyState = 1), c && g.trigger("ajaxSend", [k, p]), h))
              return k;
            p.async &&
              0 < p.timeout &&
              ...
              u
                ? (p.ifModified &&
                    ((x = k.getResponseHeader("Last-Modified")) &&
                      (w.lastModified[s] = x),
                    (x = k.getResponseHeader("etag")) && (w.etag[s] = x)),
                  204 === e || "HEAD" === p.type
                    ? (C = "nocontent")
                    : 304 === e
                    ? (C = "notmodified")
                    : ((C = y.state), (d = y.data), (u = !(m = y.error))))
                : ((m = C), (!e && C) || ((C = "error"), e < 0 && (e = 0))),
              (k.status = e),
              (k.statusText = (i || C) + ""),
              u ? v.resolveWith(f, [d, C, k]) : v.rejectWith(f, [k, C, m]),
              k.statusCode(b),
              (b = void 0),
              c &&
                g.trigger(u ? "ajaxSuccess" : "ajaxError", [k, p, u ? d : m]),
              _.fireWith(f, [k, C]),
              c &&
    ...
    w.ajaxSetup({
          ...
          return (
            ...
            n.always(function () {
              void 0 === o ? w(t).removeProp(s) : (t[s] = o),
                e[s] && ((e.jsonpCallback = i.jsonpCallback), Ye.push(s)),
                r && f(o) && o(r[0]),
                (r = o = void 0);
            }),
            "script"
      ...
      w.each(["top", "left"], function (t, e) {
        w.cssHooks[e] = jt(p.pixelPosition, function (t, i) {
          if (i)
            return (i = zt(t, e)), Lt.test(i) ? w(t).position()[e] + "px" : i;
        });
      }),
  ...
  (function (t) {
    ...
    (t.cleanData =
      ...
      (t.widget.extend = function (e) {
        for (
          var i, n, s = p.call(arguments, 1), o = 0, r = s.length;
          o < r;
          o++
        )
          for (i in s[o])
      ...
      t.each({ show: "fadeIn", hide: "fadeOut" }, function (e, i) {
        t.Widget.prototype["_" + e] = function (n, s, o) {
          var r,
            a = (s = "string" == typeof s ? { effect: s } : s)
              ? (!0 !== s && "number" != typeof s && s.effect) || i
              : e;
          "number" == typeof (s = s || {})
            ? (s = { duration: s })
            : !0 === s && (s = {}),
      ...
      (t.position = {
        scrollbarWidth: function () {
          ...
          return (
            ...
            e === (s = s.offsetWidth) && (s = n[0].clientWidth),
            n.remove(),
            (i = e - s)
          );
        },
      ...
      (t.fn.position = function (e) {
        ...
        return (
          ...
          "right" === e.at[0]
            ? (p.left += h)
            : "center" === e.at[0] && (p.left += h / 2),
          "bottom" === e.at[1]
            ? (p.top += u)
            : "center" === e.at[1] && (p.top += u / 2),
          (i = f(x.at, h, u)),
          (p.left += i[0]),
          (p.top += i[1]),
          this.each(function () {
            var o,
              ...
              m = g(this, "marginLeft"),
              v = g(this, "marginTop"),
              C = l + m + g(this, "marginRight") + y.width,
              k = c + v + g(this, "marginBottom") + y.height,
              T = t.extend({}, p),
              D = f(x.my, a.outerWidth(), a.outerHeight());
            "right" === e.my[0]
              ? (T.left -= l)
              : "center" === e.my[0] && (T.left -= l / 2),
              "bottom" === e.my[1]
                ? (T.top -= c)
            ...
            e.collisionWidth > o
              ? 0 < a && l <= 0
                ? ((i = t.left + a + e.collisionWidth - o - s),
                  (t.left += a - i))
                : (t.left =
                    !(0 < l && a <= 0) && l < a ? s + o - e.collisionWidth : s)
              : 0 < a
              ? (t.left += a)
              : 0 < l
              ? (t.left -= l)
            ...
            e.collisionHeight > o
              ? 0 < a && l <= 0
                ? ((i = t.top + a + e.collisionHeight - o - s),
                  (t.top += a - i))
                : (t.top =
                    !(0 < l && a <= 0) && l < a ? s + o - e.collisionHeight : s)
              : 0 < a
              ? (t.top += a)
              : 0 < l
              ? (t.top -= l)
        ...
        flip: {
          left: function (t, e) {
            var i = (h = e.within).offset.left + h.scrollLeft,
              ...
              c = -2 * e.offset[0];
            r < 0
              ? ((i = t.left + l + h + c + e.collisionWidth - n - i) < 0 ||
                  i < s(r)) &&
                (t.left += l + h + c)
              : 0 < a &&
                (0 <
                  (o =
                    t.left - e.collisionPosition.marginLeft + l + h + c - o) ||
                  s(o) < a) &&
                (t.left += l + h + c);
          },
          top: function (t, e) {
            var i = (h = e.within).offset.top + h.scrollTop,
              ...
              c = -2 * e.offset[1];
            r < 0
              ? ((i = t.top + l + h + c + e.collisionHeight - n - i) < 0 ||
                  i < s(r)) &&
                (t.top += l + h + c)
              : 0 < a &&
                (0 <
                  (o = t.top - e.collisionPosition.marginTop + l + h + c - o) ||
                  s(o) < a) &&
                (t.top += l + h + c);
          },
        },
      ...
      return (
        ...
        S(x, function (n, s) {
          ...
          if (o)
            return (
              (o = e[s](o)),
              (e[k[s].cache] = o[k[s].cache]),
              (i = e._rgba = o._rgba),
              !1
            );
        }),
        i.length
          ? ("0,0,0,0" === i.join() && _.extend(i, U.transparent), e)
          : U[t]
      );
    }
    function M(t, e, i) {
    ...
    (E.style.cssText = "background-color:rgba(1,1,1,.5)"),
      (D.rgba = -1 < E.style.backgroundColor.indexOf("rgba")),
      S(k, function (t, e) {
        (e.cache = "_" + t),
      ...
      ((C.fn = _.extend(C.prototype, {
        parse: function (t, e, i, n) {
          ...
          return (
            ...
            "string" === o
              ? this.parse(P(t) || U._default)
              : "array" === o
              ? (S(k.rgba.props, function (e, i) {
                  r[i.idx] = I(t[i.idx], i);
                }),
                this)
              : "object" === o
                  ...
                  t instanceof C
                    ...
                    : function (e, i) {
                        ...
                        S(i.props, function (e, o) {
                          ...
                          s[n] &&
                            _.inArray(null, s[n].slice(0, 3)) < 0 &&
                            (null == s[n][3] && (s[n][3] = 1),
                            i.from && (s._rgba = i.from(s[n])));
                      }
                ),
                this)
              : void 0
        ...
        transition: function (t, e) {
          var i = (r = C(t))._space(),
            n = k[i],
            s =
              (t = 0 === this.alpha() ? C("transparent") : this)[n.cache] ||
              n.to(t._rgba),
            o = s.slice(),
            r = r[n.cache];
          return (
            S(n.props, function (t, i) {
              var n = i.idx,
                a = s[n],
                l = r[n],
                h = T[i.type] || {};
          ...
          l =
            ...
            (i =
              r === o
                ...
                ? (60 * (n - e)) / a + 120
                : (60 * (e - i)) / a + 240),
            0 == a ? 0 : t <= 0.5 ? a / l : a / (2 - l));
        return [Math.round(i) % 360, l, t, null == s ? 1 : s];
      }),
      (k.hsla.from = function (t) {
        if (null == t[0] || null == t[1] || null == t[2])
          return [null, null, null, t[3]];
        var e = t[0] / 360,
          i = t[1],
        ...
        return [
          Math.round(255 * M(n, i, e + 1 / 3)),
          Math.round(255 * M(n, i, e)),
          Math.round(255 * M(n, i, e - 1 / 3)),
          t,
        ];
      }),
      S(k, function (t, e) {
        var i = e.props,
          ...
          o = e.from;
        (C.fn[t] = function (t) {
          if ((s && !this[n] && (this[n] = s(this._rgba)), void 0 === t))
            return this[n].slice();
          var e = A(t),
          ...
          return (
            S(i, function (t, i) {
              null == (t = r["object" === e ? t : i.idx]) && (t = a[i.idx]),
                (a[i.idx] = I(t, i));
            }),
            o ? (((t = C(o(a)))[n] = a), t) : C(a)
          );
          ...
          S(i, function (e, i) {
            C.fn[e] ||
              (C.fn[e] = function (n) {
                ...
                return "undefined" === o
                  ? l
                  : ("function" === o && (o = A((n = n.call(this, l)))),
                    null == n && i.empty
                      ? this
                      : ("string" === o &&
                          (s = w.exec(n)) &&
                          (n = l + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1)),
                        (a[i.idx] = n),
                        this[r](a)));
              });
          });
            ...
            (_.cssHooks[e] = {
              set: function (t, i) {
                var n,
                  s,
                  o = "";
                if ("transparent" !== i && ("string" !== A(i) || (n = P(i)))) {
                  if (((i = C(n || i)), !D.rgba && 1 !== i._rgba[3])) {
                    for (
              ...
              (_.fx.step[e] = function (t) {
                t.colorInit ||
                  ...
                  (t.end = C(t.end)),
                  (t.colorInit = !0)),
                  _.cssHooks[e].set(t.elem, t.start.transition(t.end, t.pos));
              });
          });
      })(
      ...
      (_.cssHooks.borderColor = {
        expand: function (t) {
          var e = {};
          return (
            S(["Top", "Right", "Bottom", "Left"], function (i, n) {
              e["border" + n + "Color"] = t;
            }),
            e
          );
    ...
    (t.effects = { effect: {} }),
                ...
                (this.diff = (function (e, i) {
                  ...
                  for (n in i)
                    (s = i[n]),
                      e[n] !== s &&
                        (W[n] ||
                          (!t.fx.step[n] && isNaN(parseFloat(s))) ||
                          (o[n] = s));
                  return o;
                })(this.start, this.end)),
                this
      ...
      t.fn.extend({
        addClass:
          ...
          function (e, i, n, s) {
            return i
              ? t.effects.animateClass.call(this, { add: e }, i, n, s)
        ...
        removeClass:
          ...
          function (e, i, n, s) {
            return 1 < arguments.length
              ? t.effects.animateClass.call(this, { remove: e }, i, n, s)
        ...
        toggleClass:
          ...
          function (e, i, n, s, o) {
            return "boolean" == typeof i || void 0 === i
              ...
              : t.effects.animateClass.call(this, { toggle: e }, i, n, s);
          }),
        ...
        t.extend(t.effects, {
          save: function (t, e) {
            for (var i = 0, n = e.length; i < n; i++)
              null !== e[i] && t.data($ + e[i], t[0].style[e[i]]);
          },
          restore: function (t, e) {
            for (var i, n = 0, s = e.length; n < s; n++)
              null !== e[n] && ((i = t.data($ + e[n])), t.css(e[n], i));
          },
        ...
        show:
          ...
          function (t) {
            return J(t)
              ...
              : (((t = Q.apply(this, arguments)).mode = "show"),
        ...
        hide:
          ...
          function (t) {
            return J(t)
              ...
              : (((t = Q.apply(this, arguments)).mode = "hide"),
                this.effect.call(this, t));
          }),
        toggle:
          ((z = t.fn.toggle),
          function (t) {
            return J(t) || "boolean" == typeof t
              ? z.apply(this, arguments)
              : (((t = Q.apply(this, arguments)).mode = "toggle"),
                this.effect.call(this, t));
          }),
        cssUnit: function (e) {
          var i = this.css(e),
      ...
      t.effects.define("bounce", function (e, i) {
        ...
        for (
          ...
          ((n = {})[f] = (g ? "-=" : "+=") + h),
            o.animate(n, d, p).animate(s, d, p),
            (h = r ? 2 * h : h / 2);
        r &&
          (((n = { opacity: 0 })[f] = (g ? "-=" : "+=") + h),
          o.animate(n, d, p)),
          o.queue(i),
          t.effects.unshift(o, e, 1 + u);
      }),
      t.effects.define("clip", "hide", function (e, i) {
        var n = {},
          s = t(this),
          o =
            (r = "both" === (a = e.direction || "vertical")) ||
            "horizontal" === a,
          r = r || "vertical" === a,
          a = s.cssClip();
        (n.clip = {
          top: r ? (a.bottom - a.top) / 2 : a.top,
          right: o ? (a.right - a.left) / 2 : a.right,
          bottom: r ? (a.bottom - a.top) / 2 : a.bottom,
          left: o ? (a.right - a.left) / 2 : a.left,
        }),
      ...
      t.effects.define("drop", "hide", function (e, i) {
        ...
        t.effects.createPlaceholder(n),
          (o =
            e.distance || n["top" == r ? "outerHeight" : "outerWidth"](!0) / 2),
          (h[r] = a + o),
      ...
      t.effects.define("explode", "hide", function (e, i) {
        ...
        function v() {
          m.push(this),
            m.length === h * c &&
              (u.css({ visibility: "visible" }), t(m).remove(), i());
        }
        for (n = 0; n < h; n++)
      ...
      t.effects.define("fold", "hide", function (e, i) {
        ...
        a && (r = (parseInt(a[1], 10) / 100) * f[o ? 0 : 1]),
          ...
          s &&
            (n.cssClip(p.clip),
            c && c.css(t.effects.clipToBox(p)),
            (p.clip = u)),
          n
            .queue(function (i) {
              c &&
                c
                  .animate(t.effects.clipToBox(d), h, e.easing)
      ...
      t.effects.define("size", function (e, i) {
        ...
        t.effects.createPlaceholder(s),
          "show" === l && ((l = g), (g = m), (m = l)),
          (n = {
            from: { y: g.height / f.height, x: g.width / f.width },
            to: { y: m.height / f.height, x: m.width / f.width },
          }),
          ("box" !== c && "both" !== c) ||
            (n.from.y !== n.to.y &&
              ((g = t.effects.setTransition(s, r, n.from.y, g)),
              (m = t.effects.setTransition(s, r, n.to.y, m))),
            n.from.x !== n.to.x &&
              ((g = t.effects.setTransition(s, a, n.from.x, g)),
              (m = t.effects.setTransition(s, a, n.to.x, m)))),
          ("content" !== c && "both" !== c) ||
            (n.from.y !== n.to.y &&
              ((g = t.effects.setTransition(s, o, n.from.y, g)),
              (m = t.effects.setTransition(s, o, n.to.y, m)))),
          u &&
          ...
          ("content" !== c && "both" !== c) ||
            ...
            s.find("*[width]").each(function () {
              var i = t(this),
                s = {
                  height: (o = t.effects.scaledDimensions(i)).height * n.from.y,
              ...
              n.from.y !== n.to.y &&
                ((s = t.effects.setTransition(i, r, n.from.y, s)),
                (o = t.effects.setTransition(i, r, n.to.y, o))),
                n.from.x !== n.to.x &&
                  ((s = t.effects.setTransition(i, a, n.from.x, s)),
                  (o = t.effects.setTransition(i, a, n.to.x, o))),
          ...
          s.animate(m, {
            ...
            complete: function () {
              var e = s.offset();
              0 === m.opacity && s.css("opacity", g.opacity),
                h ||
                  (s.css("position", "static" === d ? "relative" : d).offset(e),
        ...
        (s =
          ...
          (s = t.extend(
            !0,
            {
              ...
              to: t.effects.scaledDimensions(n, s, e.direction || "both"),
              origin: e.origin || ["middle", "center"],
            },
            e
          ));
        e.fade && ((s.from.opacity = 1), (s.to.opacity = 0)),
          t.effects.effect.size.call(this, s, i);
      }),
      ...
      t.effects.define("pulsate", "show", function (e, i) {
        var n = t(this),
          ...
          h = n.queue().length;
        for (
          (!s && n.is(":visible")) || (n.css("opacity", 0).show(), (a = 1));
          l < o;
          l++
        )
          n.animate({ opacity: a }, r, e.easing), (a = 1 - a);
        n.animate({ opacity: a }, r, e.easing),
          n.queue(i),
          t.effects.unshift(n, h, 1 + o);
      }),
      ...
      (t.ui.formResetMixin = {
        ...
        _unbindFormResetHandler: function () {
          var e;
          this.form.length &&
            ((e = this.form.data("ui-form-reset-instances")).splice(
              t.inArray(this, e),
              1
            ),
            e.length
          ...
          ? this[0].labels && this[0].labels.length
            ...
            : ((i = this.eq(0).parents("label")),
              (e = this.attr("id")) &&
                ...
                (e = "label[for='" + t.escapeSelector(e) + "']"),
                (i = i.add(n.find(e).addBack(e)))),
              this.pushStack(i))
          : this.pushStack([]);
      }),
      ...
      t.widget("ui.accordion", {
        ...
        _activate: function (e) {
          (e = this._findActive(e)[0]) !== this.active[0] &&
            ((e = e || this.active[0]),
            this._eventHandler({
              target: e,
              currentTarget: e,
        ...
        _eventHandler: function (e) {
          ...
          e.preventDefault(),
            (o && !i.collapsible) ||
              ...
              i.icons &&
                ((n = n.children(".ui-accordion-header-icon")),
                this._removeClass(n, null, i.icons.activeHeader)._addClass(
                  n,
                  null,
                  i.icons.header
                )),
              o ||
                ...
                i.icons &&
                  ((o = s.children(".ui-accordion-header-icon")),
        ...
        _animate: function (t, e, i) {
          ...
          return (
            ...
            (o =
              (o = "number" == typeof u ? u : o) || u.duration || c.duration),
            e.length
              ? t.length
          ...
          this._toggleClass(
            ...
            (i = o
              ...
              .each(function () {
                ...
                n._addClass(o, "ui-menu-icon", "ui-icon " + s),
            ...
            (e = o.add(this.element).find(this.options.items))
              .not(".ui-menu-item")
              .each(function () {
                var e = t(this);
                n._isDivider(e) &&
                  n._addClass(e, "ui-menu-divider", "ui-widget-content");
              }),
            (o = (i = e.not(".ui-menu-item, .ui-menu-divider"))
              .children()
              .not(".ui-menu")
              .uniqueId()
        ...
        _scrollIntoView: function (e) {
          ...
          this._hasScroll() &&
            ...
            i < 0
              ...
              : s < i + e && this.activeMenu.scrollTop(n + i - s + e));
        },
        blur: function (t, e) {
      ...
      t.widget("ui.autocomplete", {
        ...
        _create: function () {
          var e,
            ...
            o = "input" === o;
          (this.isMultiLine =
            s || (!o && this._isContentEditable(this.element))),
    ...
    function ot() {
      t.datepicker._isDisabledDatepicker(
        (et.inline ? et.dpDiv.parent() : et.input)[0]
      ) ||
        (t(this)
    ...
    t.widget("ui.controlgroup", {
      ...
      _spinnerOptions: function (t) {
        return (
          ((t = this._buildSimpleOptions(t, "ui-spinner")).classes[
            "ui-spinner-up"
          ] = ""),
          ...
          (e = this.options.onlyVisible ? e.filter(":visible") : e).length &&
            (t.each(["first", "last"], function (t, n) {
              ...
              o && i["_" + o.widgetName + "Options"]
                ? (((s = i["_" + o.widgetName + "Options"](
                    1 === e.length ? "only" : n
                  )).classes = i._resolveClassesValues(s.classes, o)),
              ...
              i
                ...
                : (n.length && (e = t.widget.extend.apply(null, [e].concat(n))),
                  this.each(function () {
                    var i,
                      n =
                        "checkbox" !== (i = t(this).attr("type")) &&
                        "radio" !== i
                          ? "button"
                          : "checkboxradio";
                    (i = t.data(this, "ui-" + n))
                      ? (i.option(e || {}), i._init && i._init())
                      : "button" != n
      ...
      t.ui.button,
      t.extend(t.ui, { datepicker: { version: "1.13.1" } }),
      t.extend(nt.prototype, {
        ...
        _attachDatepicker: function (e, i) {
          ...
          e.id || ((this.uuid += 1), (e.id = "dp" + this.uuid)),
            ((n = this._newInst(t(e), o)).settings = t.extend({}, i || {})),
            "input" === s
              ? this._connectDatepicker(e, n)
              : o && this._inlineDatepicker(e, n);
        },
        ...
        _attachments: function (e, i) {
          ...
          i.append && i.append.remove(),
            s &&
              ((i.append = t("<span>").addClass(this._appendClass).text(s)),
            ...
            ("button" !== n && "both" !== n) ||
              ...
              this._get(i, "buttonImageOnly")
                ...
                : ((i.trigger = t("<button type='button'>").addClass(
                    this._triggerClass
                  )),
                  n
                    ? i.trigger.html(
                        t("<img>").attr({ src: n, alt: s, title: s })
                      )
                    : i.trigger.text(s)),
        ...
        _enableDatepicker: function (e) {
          ...
          n.hasClass(this.markerClassName) &&
            ("input" === (i = e.nodeName.toLowerCase())
              ...
              : ("div" !== i && "span" !== i) ||
                ((n = n.children("." + this._inlineClass))
                  .children()
          ...
          (s = i || {}),
            ...
            r &&
              ...
              null !== n &&
                void 0 !== s.dateFormat &&
                void 0 === s.maxDate &&
                (r.settings.maxDate = this._formatDate(r, n)),
              "disabled" in s &&
                (s.disabled
        ...
        _getDateDatepicker: function (t, e) {
          return (
            (t = this._getInst(t)) && !t.inline && this._setDateFromField(t, e),
        ...
        _doKeyPress: function (e) {
          ...
          if (t.datepicker._get(n, "constrainInput"))
            return (
              ...
              e.ctrlKey || e.metaKey || n < " " || !i || -1 < i.indexOf(n)
            );
        },
        _doKeyUp: function (e) {
          if ((e = t.datepicker._getInst(e.target)).input.val() !== e.lastVal)
            try {
              t.datepicker.parseDate(
                ...
                t.datepicker._updateAlternate(e),
        ...
        _showDatepicker: function (e) {
          ...
          "input" !== (e = e.target || e).nodeName.toLowerCase() &&
            ...
            t.datepicker._isDisabledDatepicker(e) ||
              ...
              !1 !==
                (n = (s = t.datepicker._get(o, "beforeShow"))
                  ? s.apply(e, [e, o])
                  : {}) &&
                (rt(o.settings, n),
                (o.lastVal = null),
                ...
                o.inline ||
                  ...
                  t.effects && t.effects.effect[n]
                    ? o.dpDiv.show(n, t.datepicker._get(o, "showOptions"), s)
                    : o.dpDiv[n || "show"](n ? s : null),
                  t.datepicker._shouldFocusInput(o) && o.input.trigger("focus"),
                  (t.datepicker._curInst = o))));
        },
        _updateDatepicker: function (e) {
          (this.maxRows = 4),
            (et = e).dpDiv.empty().append(this._generateHTML(e)),
        ...
        _checkOffset: function (e, i, n) {
          ...
          return (
            ...
            (i.left -= Math.min(
              i.left,
              i.left + s > l && s < l ? Math.abs(i.left + s - l) : 0
            )),
            (i.top -= Math.min(
              i.top,
              i.top + o > h && o < h ? Math.abs(o + a) : 0
            )),
            i
          );
        },
        _findPos: function (e) {
          for (
            var i = this._getInst(e), n = this._get(i, "isRTL");
            e &&
            ("hidden" === e.type ||
              1 !== e.nodeType ||
              t.expr.pseudos.hidden(e));
          ...
          !s ||
            ...
            (this._datepickerShowing &&
              ...
              t.effects && (t.effects.effect[i] || t.effects[i])
                ? s.dpDiv.hide(i, t.datepicker._get(s, "showOptions"), n, e)
                : s.dpDiv[
                    "slideDown" === i
                      ? "slideUp"
                      : "fadeIn" === i
              ...
              i || e(),
              (this._datepickerShowing = !1),
              (e = this._get(s, "onClose")) &&
                e.apply(s.input ? s.input[0] : null, [
                  s.input ? s.input.val() : "",
                  s,
                ]),
        ...
        _adjustDate: function (e, i, n) {
          ...
          this._isDisabledDatepicker(s[0]) ||
            (this._adjustInstDate(e, i, n), this._updateDatepicker(e));
        },
        ...
        _selectMonthYear: function (e, i, n) {
          var s = t(e);
          ((e = this._getInst(s[0]))[
            "selected" + ("M" === n ? "Month" : "Year")
          ] = e["draw" + ("M" === n ? "Month" : "Year")] =
        ...
        _selectDay: function (e, i, n, s) {
          ...
          t(s).hasClass(this._unselectableClass) ||
            ...
            (((o = this._getInst(o[0])).selectedDay = o.currentDay =
              parseInt(t("a", s).attr("data-date"))),
        ...
        _selectDate: function (e, i) {
          ...
          (i = null != i ? i : this._formatDate(e)),
            ...
            (n = this._get(e, "onSelect"))
              ? n.apply(e.input ? e.input[0] : null, [i, e])
        ...
        _updateAlternate: function (e) {
          ...
          s &&
            ...
            (n = this._getDate(e)),
            (e = this.formatDate(i, n, this._getFormatConfig(e))),
            t(document).find(s).val(e));
        },
        ...
        parseDate: function (e, i, n) {
          ...
          for (
            var s,
              ...
              _ = function (t) {
                return (
                  (t = x + 1 < e.length && e.charAt(x + 1) === t) && x++, t
                );
              },
              b = function (t) {
                var e = _(t);
          ...
          if (a < i.length && ((o = i.substr(a)), !/^\s+/.test(o)))
          ...
          if (
            ...
            for (f = 1, g = m; !(g <= (s = this._getDaysInMonth(p, f - 1))); )
              f++, (g -= s);
          if (
        ...
        _possibleChars: function (t) {
          for (
            var e = "",
              ...
              n = function (e) {
                return (
                  (e = s + 1 < t.length && t.charAt(s + 1) === e) && s++, e
                );
              },
              s = 0;
            s < t.length;
        ...
        _generateHTML: function (e) {
          var i,
            ...
            q = ((N = this._get(e, "stepMonths")), 1 !== j[0] || 1 !== j[1]),
            B = this._daylightSavingAdjust(
              e.currentDay
                ? new Date(e.currentYear, e.currentMonth, e.currentDay)
                : new Date(9999, 9, 9)
            ),
            Y = this._getMinMaxDate(e, "min"),
          ...
          if ((U < 0 && ((U += 12), $--), X))
            for (
              i = this._daylightSavingAdjust(
                new Date(
                  X.getFullYear(),
                  X.getMonth() - j[0] * j[1] + 1,
                  X.getDate()
                )
              ),
                i = Y && i < Y ? Y : i;
              this._daylightSavingAdjust(new Date($, U, 1)) > i;
          ...
          for (
            e.drawMonth = U,
              ...
              F = z
                ? this.formatDate(
                    F,
                    this._daylightSavingAdjust(new Date($, U - N, 1)),
              ...
              R = this._get(e, "gotoCurrent") && e.currentDay ? B : L,
              N = z ? this.formatDate(N, R, this._getFormatConfig(e)) : N,
              F = "",
              e.inline ||
                (F = t("<button>")
                  .attr({
            ...
            for (_ = "", this.maxRows = 4, b = 0; b < j[1]; b++) {
              ...
              for (
                x +=
                  ...
                  w +
                  "'>" +
                  (/all|left/.test(w) && 0 === v ? (H ? s : n) : "") +
                  (/all|right/.test(w) && 0 === v ? (H ? n : s) : "") +
              ...
              for (
                x += C + "</tr></thead><tbody>",
                  D = this._getDaysInMonth($, U),
                  $ === e.selectedYear &&
                    U === e.selectedMonth &&
                    (e.selectedDay = Math.min(e.selectedDay, D)),
                  T = (this._getFirstDayOfMonth($, U) - o + 7) % 7,
                  D = Math.ceil((T + D) / 7),
                  E = q && this.maxRows > D ? this.maxRows : D,
                  this.maxRows = E,
                  S = this._daylightSavingAdjust(new Date($, U, 1 - T)),
                  A = 0;
                A < E;
                A++
              ) {
                for (
                  ...
                  (P = u
                    ? u.apply(e.input ? e.input[0] : null, [S])
                    : [!0, ""]),
                    (O =
                      ((M = S.getMonth() !== U) && !p) ||
                      !P[0] ||
                    ...
                    (I +=
                      ...
                      (M && !d
                        ...
                        : "<a class='ui-state-default" +
                          ...
                          "' href='#' aria-current='" +
                          (S.getTime() === B.getTime() ? "true" : "false") +
                          "' data-date='" +
                          S.getDate() +
                          "'>" +
                          S.getDate() +
        ...
        _adjustInstDate: function (t, e, i) {
          ...
          (e =
            ...
            (e = this._restrictMinMax(
              t,
              this._daylightSavingAdjust(new Date(n, s, e))
            ));
        ...
        _getNumberOfMonths: function (t) {
          return null == (t = this._get(t, "numberOfMonths"))
            ? [1, 1]
            : "number" == typeof t
            ? [1, t]
            : t;
    ...
    t(document).on("mouseup", function () {
      ...
      t.widget("ui.draggable", t.ui.mouse, {
        ...
        _mouseDrag: function (e, i) {
          if (
            ...
            if (((i = this._uiHash()), !1 === this._trigger("drag", e, i)))
        ...
        _getParentOffset: function () {
          ...
          return (
            ...
            {
              top:
                (e = this._isRootNode(this.offsetParent[0])
                  ? { top: 0, left: 0 }
                  : e).top +
        ...
        drag: function (e, i, n) {
          for (
            var s,
              ...
              b = n.snapElements.length - 1;
            0 <= b;
            b--
          )
            (h =
              (l = n.snapElements[b].left - n.margins.left) +
              n.snapElements[b].width),
              (u =
                (c = n.snapElements[b].top - n.margins.top) +
                n.snapElements[b].height),
              m < l - f ||
              h + f < g ||
              _ < c - f ||
              u + f < v ||
              !t.contains(
                n.snapElements[b].item.ownerDocument,
                n.snapElements[b].item
              )
                ? (n.snapElements[b].snapping &&
                    n.options.snap.release &&
                    n.options.snap.release.call(
                      n.element,
                      e,
                      t.extend(n._uiHash(), {
                        snapItem: n.snapElements[b].item,
                      })
                    ),
                  (n.snapElements[b].snapping = !1))
                : ("inner" !== p.snapMode &&
                    ((s = Math.abs(c - _) <= f),
                    (o = Math.abs(u - v) <= f),
                    (r = Math.abs(l - m) <= f),
      ...
      t.widget("ui.resizable", t.ui.mouse, {
        ...
        _renderProxy: function () {
          ...
          (this.elementOffset = e.offset()),
            this._helper
              ? ((this.helper =
                  this.helper || t("<div></div>").css({ overflow: "hidden" })),
      ...
      t.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (e) {
          ...
          l[0] !== document && /static/.test(l.css("position")) && (a = s),
            ...
            (o = Math.abs(
              i.sizeDiff.width +
                (i._helper ? i.offset.left - a.left : i.offset.left - s.left)
            )),
            (s = Math.abs(
              i.sizeDiff.height +
                (i._helper ? i.offset.top - a.top : i.offset.top - s.top)
            )),
        ...
        _moveToTop: function (e, i) {
          var n = !1,
            s = this.uiDialog
              ...
              .get();
          return (
            (s = Math.max.apply(null, s)) >= +this.uiDialog.css("z-index") &&
          ...
          this.uiDialogButtonPane.remove(),
            ...
            t.isEmptyObject(i) || (Array.isArray(i) && !i.length)
              ...
              : (t.each(i, function (i, n) {
                  ...
                  (n = t.extend(
                    { type: "button" },
                    (n = "function" == typeof n ? { click: n, text: i } : n)
                  )),
                    (s = n.click),
                    (i = {
                      icon: n.icon,
        ...
        _makeResizable: function () {
          ...
          this.uiDialog
            .resizable({
              ...
              stop: function (n, s) {
                var r =
                    (a = e.uiDialog.offset()).left - e.document.scrollLeft(),
          ...
          "disabled" !== e &&
            ...
            "resizable" === e &&
              ((n = s.is(":data(ui-resizable)")) &&
                !i &&
                s.resizable("destroy"),
              n && "string" == typeof i && s.resizable("option", "handles", i),
            ...
            this.document.data("ui-dialog-overlays") ||
              this.document.on(
                ...
                function (t) {
                  var n;
                  i ||
                    (n = this._trackingInstances()[0])._allowInteraction(t) ||
                    (t.preventDefault(),
                    n._focusTabbable(),
                    ("3.4." !== e && "3.5." !== e) ||
                      n._delay(n._restoreTabbableFocus));
                }.bind(this)
              ),
      ...
      t.widget("ui.droppable", {
        ...
        _setOption: function (e, i) {
          ...
          "accept" === e
            ...
            : "scope" === e &&
              ((n = t.ui.ddmanager.droppables[this.options.scope]),
              this._splice(n),
        ...
        switch (i) {
          ...
          case "intersect":
            return (
              ...
              r - t.helperProportions.width / 2 < c &&
              h < o + t.helperProportions.height / 2 &&
              a - t.helperProportions.height / 2 < u
            );
          case "pointer":
            return (
              ht(n.pageY, h, e.proportions().height) &&
              ht(n.pageX, l, e.proportions().width)
            );
          case "touch":
            return (
            ...
            (this.refresh = function () {
              (e.elementPos = t(e.element[0]).offset()),
                ...
                e.selectees.each(function () {
                  var i = t(this),
                    n = {
                      left: (n = i.offset()).left - e.elementPos.left,
              ...
              this.selectees.each(function () {
                ...
                i &&
                  ...
                  "touch" === s.tolerance
                    ...
                    : "fit" === s.tolerance &&
                      (h =
                        c.left > o && c.right < a && c.top > r && c.bottom < l),
                  h
                    ? (i.selected &&
        ...
        t.ui.formResetMixin,
        {
                ...
                .menu({
                  ...
                  focus: function (t, i) {
                    (i = i.item.data("ui-selectmenu-item")),
                      null != e.focusIndex &&
                        i.index !== e.focusIndex &&
                        (e._trigger("focus", t, { item: i }),
                        e.isOpen || e._select(i, t)),
                      (e.focusIndex = i.index),
                      e.button.attr(
                        "aria-activedescendant",
                        e.menuItems.eq(i.index).attr("id")
                      );
                  },
                })
                .menu("instance")),
          ...
          _documentClick: {
            mousedown: function (e) {
              this.isOpen &&
                (t(e.target).closest(
                  ".ui-selectmenu-menu, #" + t.escapeSelector(this.ids.button)
                ).length ||
                  this.close(e));
            },
          },
      ...
      t.widget("ui.slider", t.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          for (
            n.length > o && (n.slice(o).remove(), (n = n.slice(0, o))),
              e = n.length;
            e < o;
            e++
          )
        ...
        values: function (t, e) {
          ...
          for (i = this.options.values, n = t, s = 0; s < i.length; s += 1)
      ...
      t.widget("ui.sortable", t.ui.mouse, {
        ...
        _refreshItems: function (e) {
          ...
          for (i = u.length - 1; 0 <= i; i--)
            for (r = u[i][1], h = (a = u[i][(n = 0)]).length; n < h; n++)
          ...
          for (
            ...
            t.contains(this.currentItem[0], this.containers[p].element[0]) ||
              (this._intersectsWith(this.containers[p].containerCache)
                ? (u &&
                    t.contains(this.containers[p].element[0], u.element[0])) ||
                  ((u = this.containers[p]), (d = p))
                : this.containers[p].containerCache.over &&
                  (this.containers[p]._trigger("out", e, this._uiHash(this)),
        ...
        _createHelper: function (e) {
          ...
          return (
            ...
            (e[0].style.width && !i.forceHelperSize) ||
              e.width(this.currentItem.width()),
            (e[0].style.height && !i.forceHelperSize) ||
          ...
          return (
            ...
            this.originalPosition &&
              ...
              i.grid &&
                ((e =
                  this.originalPageY +
                  Math.round((s - this.originalPageY) / i.grid[1]) * i.grid[1]),
                (s =
                  !this.containment ||
                ...
                (e =
                  this.originalPageX +
                  Math.round((n - this.originalPageX) / i.grid[0]) * i.grid[0]),
                (n =
                  !this.containment ||
      ...
      t.widget("ui.spinner", {
        ...
        _adjustValue: function (t) {
          var e = this.options,
            ...
            n = t - i;
          return (
            (t = i + Math.round(n / e.step) * e.step),
      ...
      t.widget("ui.tabs", {
        ...
        _activate: function (e) {
          (e = this._findActive(e))[0] !== this.active[0] &&
            ((e = (e = e.length ? e : this.active).find(".ui-tabs-anchor")[0]),
            this._eventHandler({
              target: e,
              currentTarget: e,
              preventDefault: t.noop,
        ...
        load: function (e, i) {
          function n(t, e) {
            "abort" === e && s.panels.stop(!1, !0),
              s._removeClass(o, "ui-tabs-loading"),
      ...
      t.widget("ui.tooltip", {
        ...
        _removeDescribedBy: function (e) {
          ...
          -1 !== (i = t.inArray(i, n)) && n.splice(i, 1),
          ...
          n &&
            ((s = this._find(i))
              ...
              : (i.is("[title]") &&
                ...
                (n = t("<div>").html(o.find(".ui-tooltip-content").html()))
                  .removeAttr("name")
                  .find("[name]")
                  .removeAttr("name"),
                ...
                this.options.track && e && /^mouse/.test(e.type)
                  ? (this._on(this.document, { mousemove: l }), l(e))
        ...
        _registerCloseHandlers: function (e, i) {
          var n = {
            keyup: function (e) {
              e.keyCode === t.ui.keyCode.ESCAPE &&
                (((e = t.Event(e)).currentTarget = i[0]), this.close(e, !0));
            },
          };
          i[0] !== this.element[0] &&
            (n.remove = function () {
        ...
        _appendTo: function (t) {
          return (t = t.closest(".ui-front, dialog")).length
            ? t
            : this.document[0].body;
        },
        _destroy: function () {
  ...
  (function (t, e) {
    ...
    const t = "transitionend",
      ...
      _ = (e, i, n = !0) => {
        ...
        let r = !1;
        const a = ({ target: n }) => {
          n === i && ((r = !0), i.removeEventListener(t, a), v(e));
        };
    ...
    const L = {
        ...
        off(t, e, i, n) {
          ...
          if (void 0 !== o) {
            if (!l || !l[r]) return;
            return void O(t, l, r, o, s ? i : null);
          }
          h &&
            Object.keys(l).forEach((i) => {
              !(function (t, e, i, n) {
                ...
                Object.keys(s).forEach((o) => {
                  if (o.includes(n)) {
                    const n = s[o];
                    O(t, e, i, n.originalHandler, n.delegationSelector);
                  }
                });
              })(t, l, i, e.slice(1));
            });
          ...
          Object.keys(c).forEach((i) => {
            ...
            if (!a || e.includes(n)) {
              const e = c[i];
              O(t, l, r, e.originalHandler, e.delegationSelector);
            }
          });
        },
        trigger(t, e, i) {
    ...
    class R {
      ...
      static getInstance(t) {
        return W.get(r(t), this.DATA_KEY);
      }
    ...
    const z = (t, e = "hide") => {
      const i = `click.dismiss${t.EVENT_KEY}`,
        s = t.NAME;
      L.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
        if (
    ...
    L.on(document, "click.bs.button.data-api", F, (t) => {
      t.preventDefault();
    ...
    const X = {
        ...
        getDataAttribute: (t, e) => B(t.getAttribute(`data-bs-${Y(e)}`)),
        offset(t) {
    ...
    class st extends R {
      ...
      to(t) {
        this._activeElement = U.findOne(nt, this._element);
        const e = this._getItemIndex(this._activeElement);
        if (t > this._items.length - 1 || t < 0) return;
        if (this._isSliding)
          return void L.one(this._element, et, () => this.to(t));
      ...
      _handleSwipe() {
        ...
        (this.touchDeltaX = 0), e && this._slide(e > 0 ? Z : J);
      }
      _addEventListeners() {
        this._config.keyboard &&
          L.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
          "hover" === this._config.pause &&
            (L.on(this._element, "mouseenter.bs.carousel", (t) =>
              this.pause(t)
            ),
            L.on(this._element, "mouseleave.bs.carousel", (t) =>
              this.cycle(t)
            )),
          this._config.touch &&
            this._touchSupported &&
      ...
      _addTouchEventListeners() {
        ...
        U.find(".carousel-item img", this._element).forEach((t) => {
          ...
          this._pointerEvent
            ? (L.on(this._element, "pointerdown.bs.carousel", (t) => e(t)),
              L.on(this._element, "pointerup.bs.carousel", (t) => n(t)),
              this._element.classList.add("pointer-event"))
            : (L.on(this._element, "touchstart.bs.carousel", (t) => e(t)),
              L.on(this._element, "touchmove.bs.carousel", (t) => i(t)),
              L.on(this._element, "touchend.bs.carousel", (t) => n(t)));
      }
      _keydown(t) {
      ...
      _triggerSlideEvent(t, e) {
        const i = this._getItemIndex(t),
          n = this._getItemIndex(U.findOne(nt, this._element));
      ...
      _updateInterval() {
        const t = this._activeElement || U.findOne(nt, this._element);
        if (!t) return;
      ...
      _slide(t, e) {
        ...
        if (this._element.classList.contains("slide")) {
          o.classList.add(c), d(o), n.classList.add(h), o.classList.add(h);
          const t = () => {
            o.classList.remove(h, c),
              o.classList.add(it),
              n.classList.remove(it, c, h),
              (this._isSliding = !1),
              setTimeout(p, 0);
          };
          this._queueCallback(t, n, !0);
        } else n.classList.remove(it), o.classList.add(it), (this._isSliding = !1), p();
        a && this.cycle();
      }
      _directionToOrder(t) {
        return [Z, J].includes(t)
          ? g()
            ? t === J
              ? Q
              : G
    ...
    class ft extends R {
      ...
      show() {
        ...
        if (this._config.parent) {
          const t = U.find(dt, this._config.parent);
          e = U.find(
        ...
        if (e.length) {
          ...
          if (((t = n ? ft.getInstance(n) : null), t && t._isTransitioning))
            return;
        }
        if (L.trigger(this._element, "show.bs.collapse").defaultPrevented)
          return;
        e.forEach((e) => {
          i !== e && ft.getOrCreateInstance(e, { toggle: !1 }).hide(),
        ...
        this._queueCallback(
          () => {
            (this._isTransitioning = !1),
              ...
              this._element.classList.add(ht, lt),
      ...
      hide() {
        ...
        (this._element.style[t] = `${
          ...
          d(this._element),
          this._element.classList.add(ct),
          this._element.classList.remove(ht, lt);
      ...
      _getConfig(t) {
        return (
          ((t = { ...rt, ...X.getDataAttributes(this._element), ...t }).toggle =
            Boolean(t.toggle)),
          (t.parent = r(t.parent)),
          a(ot, t, at),
          t
      ...
      _addAriaAndCollapsedClass(t, e) {
        t.length &&
          t.forEach((t) => {
            e ? t.classList.remove(ut) : t.classList.add(ut),
    ...
    L.on(document, "click.bs.collapse.data-api", pt, function (t) {
      ("A" === t.target.tagName ||
    ...
    var gt = "top",
      ...
      Tt = "popper",
      Dt = "reference",
      Et = yt.reduce(function (t, e) {
        return t.concat([e + "-" + wt, e + "-" + xt]);
      }, []),
      St = [].concat(yt, [bt]).reduce(function (t, e) {
    ...
    function Ft(t) {
      return t instanceof jt(t).Element || t instanceof Element;
    }
    function qt(t) {
      return t instanceof jt(t).HTMLElement || t instanceof HTMLElement;
    }
    function Bt(t) {
      return (
    ...
    function Jt(t) {
      return "html" === zt(t)
        ? t
        : t.assignedSlot || t.parentNode || (Bt(t) ? t.host : null) || Qt(t);
    }
    function Zt(t) {
      return qt(t) && "fixed" !== Vt(t).position ? t.offsetParent : null;
    }
    function te(t) {
      for (
        var e = jt(t), i = Zt(t);
        i && Gt(i) && "static" === Vt(i).position;

      )
        i = Zt(i);
      return i &&
        ("html" === zt(i) || ("body" === zt(i) && "static" === Vt(i).position))
        ? e
        : i ||
            (function (t) {
              var e =
    ...
    const le = {
      ...
      fn: function (t) {
        var e,
          ...
          a = Xt(i.placement),
          l = ee(a),
          h = [_t, vt].indexOf(a) >= 0 ? "height" : "width";
        if (o && r) {
          var c = (function (t, e) {
              return re(
                "number" !=
            ...
            x = oe(b, w, y),
            C = l;
          i.modifiersData[n] = (((e = {})[C] = x), (e.centerOffset = x - w), e);
        }
      },
      effect: function (t) {
        var e = t.state,
    ...
    function ue(t) {
      ...
      if (h) {
        var w = te(i),
          ...
          C = "clientWidth";
        w === jt(i) &&
          "static" !== Vt((w = Qt(i))).position &&
          "absolute" === a &&
          ((x = "scrollHeight"), (C = "scrollWidth")),
          (w = w),
          (s !== gt && ((s !== _t && s !== vt) || o !== xt)) ||
            ((b = mt), (g -= w[x] - n.height), (g *= l ? 1 : -1)),
          (s !== _t && ((s !== gt && s !== mt) || o !== xt)) ||
            ((_ = vt), (p -= w[C] - n.width), (p *= l ? 1 : -1));
      }
      var k,
        T = Object.assign({ position: a }, h && ce);
      return l
        ? Object.assign(
            {},
            T,
    ...
    function ye(t) {
      return Ut(Qt(t)).left + be(t).scrollLeft;
    }
    function we(t) {
      var e = Vt(t),
        i = e.overflow,
    ...
    function Ee(t, e) {
      ...
      var i = e,
        ...
        p = i.padding,
        f = void 0 === p ? 0 : p,
        g = re("number" != typeof f ? f : ae(f, yt)),
        m = c === Tt ? Dt : Tt,
        v = t.rects.popper,
        _ = t.elements[d ? m : c],
        b = (function (t, e, i) {
        ...
        })(Ft(_) ? _ : _.contextElement || Qt(t.elements.popper), r, l),
        y = Ut(t.elements.reference),
        w = De({
          reference: y,
          element: v,
          strategy: "absolute",
    ...
    function Ie(t) {
      return [gt, vt, mt, _t].some(function (e) {
        return t[e] >= 0;
      });
    }
    const Pe = {
        ...
        fn: function (t) {
          var e = t.state,
            ...
            r = Ee(e, { elementContext: "reference" }),
      ...
      Me = {
        ...
        fn: function (t) {
          var e = t.state,
            ...
            s = i.offset,
            o = void 0 === s ? [0, 0] : s,
            r = St.reduce(function (t, i) {
              return (
                (t[i] = (function (t, e, i) {
                  var n = Xt(t),
                    s = [_t, gt].indexOf(n) >= 0 ? -1 : 1,
                    o =
                      "function" == typeof i
                  ...
                  return (
                    (r = r || 0),
                    (a = (a || 0) * s),
                    [_t, vt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                  );
                })(i, e.rects, o)),
                t
              );
          ...
          if (x) {
            if (o || a) {
              var E = "y" === y ? gt : _t,
                ...
                j = R[S],
                F = oe(0, C[A], W[A]),
                q = b ? C[A] / 2 - O - F - z - T : N - F - z - T,
                B = b ? -C[A] / 2 + O + F + j + T : L + F + j + T,
                Y = e.elements.arrow && te(e.elements.arrow),
                ...
                K = x[y] + B - U;
              if (o) {
                var V = oe(p ? ne(P, $) : P, I, p ? ie(M, K) : M);
                (x[y] = V), (D[y] = V - I);
              }
              if (a) {
                var G = "x" === y ? gt : _t,
          ...
          (("body" !== zt(e) || we(r)) &&
            (l =
              (s = e) !== jt(s) && qt(s)
                ...
                : be(s)),
          qt(e)
            ? (((h = Ut(e)).x += e.clientLeft), (h.y += e.clientTop))
            : r && (h.x = ye(r))),
        {
          ...
          c = {
            ...
            forceUpdate: function () {
              if (!h) {
                ...
                if (Re(e, i)) {
                  (a.rects = {
                    reference: Le(e, te(i), "fixed" === a.options.strategy),
                    popper: $t(i),
                  }),
                    (a.reset = !1),
                  ...
                  for (var n = 0; n < a.orderedModifiers.length; n++)
                    if (!0 !== a.reset) {
                      ...
                      "function" == typeof o &&
                        (a =
                          o({ state: a, options: l, name: u, instance: c }) ||
                          a);
                    } else (a.reset = !1), (n = -1);
                }
              }
    ...
    var je = ze(),
      Fe = ze({ defaultModifiers: [fe, Oe, de, Yt] }),
      qe = ze({ defaultModifiers: [fe, Oe, de, Yt, Me, Se, Ne, le, Pe] });
    const Be = Object.freeze({
      ...
      ti = ".dropdown-menu",
      ei = g() ? "top-end" : "top-start",
      ii = g() ? "top-start" : "top-end",
      ni = g() ? "bottom-end" : "bottom-start",
      si = g() ? "bottom-start" : "bottom-end",
      oi = g() ? "left-start" : "right-start",
      ri = g() ? "right-start" : "left-start",
      ai = {
        offset: [0, 2],
    ...
    class hi extends R {
      ...
      _completeHide(t) {
        L.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
          ("ontouchstart" in document.documentElement &&
            []
              .concat(...document.body.children)
              .forEach((t) => L.off(t, "mouseover", u)),
          this._popper && this._popper.destroy(),
          this._menu.classList.remove(Je),
          this._element.classList.remove(Je),
          this._element.setAttribute("aria-expanded", "false"),
          X.removeDataAttribute(this._menu, "popper"),
          L.trigger(this._element, "hidden.bs.dropdown", t));
      }
      _getConfig(t) {
        if (
          ((t = {
          ...
          a(Ye, t, this.constructor.DefaultType),
      ...
      _getMenuElement() {
        return U.next(this._element, ti)[0];
      }
      _getPlacement() {
      ...
      static dataApiKeydownHandler(t) {
        if (
          /input|textarea/i.test(t.target.tagName)
            ? t.key === Ue ||
              (t.key !== Xe &&
                ((t.key !== Ke && t.key !== $e) || t.target.closest(ti)))
            : !Ve.test(t.key)
        )
          return;
        ...
        const i = this.matches(Ze) ? this : U.prev(this, Ze)[0],
          n = hi.getOrCreateInstance(i);
        if (t.key !== Xe)
          return t.key === $e || t.key === Ke
            ? (e || n.show(), void n._selectMenuItem(t))
            : void ((e && t.key !== Ue) || hi.clearMenus());
        n.hide();
      }
    }
    L.on(document, Qe, Ze, hi.dataApiKeydownHandler),
      L.on(document, Qe, ti, hi.dataApiKeydownHandler),
      L.on(document, Ge, hi.clearMenus),
      L.on(document, "keyup.bs.dropdown.data-api", hi.clearMenus),
      L.on(document, Ge, Ze, function (t) {
    ...
    class di {
      ...
      hide() {
        ...
        this._disableOverFlow(),
          ...
          this._setElementAttributes(ci, "paddingRight", (e) => e + t),
    ...
    const _i = { trapElement: null, autofocus: !0 },
    ...
    class xi {
      ...
      activate() {
        ...
        this._isActive ||
          ...
          L.on(document, "keydown.tab.bs.focustrap", (t) =>
            this._handleKeydown(t)
          ),
          (this._isActive = !0));
      }
      deactivate() {
        this._isActive && ((this._isActive = !1), L.off(document, yi));
      }
      _handleFocusin(t) {
        const { target: e } = t,
    ...
    class Hi extends R {
      ...
      show(t) {
        this._isShown ||
          ...
          L.trigger(this._element, Si, { relatedTarget: t }).defaultPrevented ||
          ((this._isShown = !0),
          ...
          L.on(this._dialog, Mi, () => {
            L.one(this._element, "mouseup.dismiss.bs.modal", (t) => {
      ...
      hide() {
        ...
        t && (this._isTransitioning = !0),
          ...
          L.off(this._element, Ii),
          L.off(this._dialog, Mi),
          this._queueCallback(() => this._hideModal(), this._element, t);
      }
      dispose() {
        [window, this._dialog].forEach((t) => L.off(t, ".bs.modal")),
      ...
      _setEscapeEvent() {
        this._isShown
          ? L.on(this._element, Pi, (t) => {
              this._config.keyboard && t.key === ki
                ? (t.preventDefault(), this.hide())
                : this._config.keyboard ||
                  t.key !== ki ||
                  this._triggerBackdropTransition();
            })
          : L.off(this._element, Pi);
      }
      _setResizeEvent() {
        this._isShown
          ? L.on(window, Ai, () => this._adjustDialog())
          : L.off(window, Ai);
      }
      _hideModal() {
        (this._element.style.display = "none"),
          ...
          this._backdrop.hide(() => {
            document.body.classList.remove(Oi),
              ...
              L.trigger(this._element, Ei);
          });
      }
      _showBackdrop(t) {
        L.on(this._element, Ii, (t) => {
    ...
    class Bi extends R {
      ...
      show(t) {
        this._isShown ||
          L.trigger(this._element, "show.bs.offcanvas", { relatedTarget: t })
            .defaultPrevented ||
          ((this._isShown = !0),
    ...
    const Yi = new Set([
      ...
      $i = (t, e) => {
        ...
        if (e.includes(i))
          return (
            !Yi.has(i) || Boolean(Xi.test(t.nodeValue) || Ui.test(t.nodeValue))
          );
    ...
    function Ki(t, e, i) {
      ...
      for (let t = 0, i = s.length; t < i; t++) {
        ...
        const o = [].concat(...i.attributes),
          r = [].concat(e["*"] || [], e[n] || []);
        o.forEach((t) => {
          $i(t, r) || i.removeAttribute(t.nodeName);
        });
      }
    ...
    class un extends R {
      ...
      dispose() {
        clearTimeout(this._timeout),
          L.off(this._element.closest(an), ln, this._hideModalHandler),
      ...
      show() {
        ...
        W.set(n, this.constructor.DATA_KEY, this),
          this._element.ownerDocument.documentElement.contains(this.tip) ||
            (a.append(n),
            L.trigger(this._element, this.constructor.Event.INSERTED)),
          this._popper
            ? this._popper.update()
        ...
        const h = this.tip.classList.contains(en);
        this._queueCallback(
          () => {
            const t = this._hoverState;
            (this._hoverState = null),
              L.trigger(this._element, this.constructor.Event.SHOWN),
      ...
      hide() {
        ...
        if (
          L.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented
        )
          return;
      ...
      _setListeners() {
        this._config.trigger.split(" ").forEach((t) => {
          if ("click" === t)
            ...
            L.on(this._element, e, this._config.selector, (t) =>
              this._enter(t)
            ),
              L.on(this._element, i, this._config.selector, (t) =>
                this._leave(t)
              );
          }
        }),
          ...
          L.on(this._element.closest(an), ln, this._hideModalHandler),
          this._config.selector
            ? (this._config = {
                ...this._config,
                trigger: "manual",
      ...
      _enter(t, e) {
        (e = this._initializeOnDelegatedTarget(t, e)),
          t && (e._activeTrigger["focusin" === t.type ? cn : hn] = !0),
      ...
      _leave(t, e) {
        (e = this._initializeOnDelegatedTarget(t, e)),
          t &&
            (e._activeTrigger["focusout" === t.type ? cn : hn] =
      ...
      _getConfig(t) {
        ...
        return (
          ...
          a(Vi, t, this.constructor.DefaultType),
          t.sanitize &&
    ...
    const mn = "scrollspy",
      ...
      _n = { offset: "number", method: "string", target: "(string|element)" },
      bn = "active",
    ...
    class xn extends R {
      constructor(t, e) {
        super(t),
          ...
          L.on(this._scrollElement, "scroll.bs.scrollspy", () =>
            this._process()
          ),
          this.refresh(),
          this._process();
      ...
      dispose() {
        L.off(this._scrollElement, ".bs.scrollspy"), super.dispose();
      }
      _getConfig(t) {
        return (
          ((t = {
    ...
    L.on(window, "load.bs.scrollspy.data-api", () => {
      U.find('[data-bs-spy="scroll"]').forEach((t) => new xn(t));
    }),
      m(xn);
    const Cn = "active",
      kn = "fade",
    ...
    class Sn extends R {
      ...
      show() {
        ...
        if (i) {
          const e = "UL" === i.nodeName || "OL" === i.nodeName ? En : Dn;
          (t = U.find(e, i)), (t = t[t.length - 1]);
        }
        const s = t
          ? L.trigger(t, "hide.bs.tab", { relatedTarget: this._element })
          : null;
        if (
          L.trigger(this._element, "show.bs.tab", { relatedTarget: t })
            .defaultPrevented ||
        ...
        const o = () => {
          L.trigger(t, "hidden.bs.tab", { relatedTarget: this._element }),
            L.trigger(this._element, "shown.bs.tab", { relatedTarget: t });
        };
      ...
      _transitionComplete(t, e, i) {
        ...
        t.classList.add(Cn),
          ...
          d(t),
          t.classList.contains(kn) && t.classList.add(Tn);
        let n = t.parentNode;
        if (
          ...
          e &&
            U.find(".dropdown-toggle", e).forEach((t) => t.classList.add(Cn)),
    ...
    L.on(
      ...
      function (t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
          h(this) || Sn.getOrCreateInstance(this).show();
      }
    ),
      m(Sn);
    const An = "toast",
    ...
    class Ln extends R {
      ...
      _getConfig(t) {
        return (
          ...
          a(An, t, this.constructor.DefaultType),
          t
        );
      }
      _maybeScheduleHide() {
      ...
      _setListeners() {
        L.on(this._element, "mouseover.bs.toast", (t) =>
          this._onInteraction(t, !0)
        ),
          L.on(this._element, "mouseout.bs.toast", (t) =>
            this._onInteraction(t, !1)
          ),
          L.on(this._element, "focusin.bs.toast", (t) =>
            this._onInteraction(t, !0)
          ),
          L.on(this._element, "focusout.bs.toast", (t) =>
            this._onInteraction(t, !1)
          );
      }
      _clearTimeout() {
  ...
  (function (t, e) {
    ...
    function d(t, e, i, n, s) {
      ...
      !(function (t, e, i, n, s) {
        ...
        (t.reach[l] = null),
          ...
          e &&
            (p.dispatchEvent(u("ps-scroll-" + l)),
            0 > e
              ? p.dispatchEvent(u("ps-scroll-" + h))
              : 0 < e && p.dispatchEvent(u("ps-scroll-" + d)),
            n && c(t, l)),
          t.reach[l] &&
            (e || s) &&
            p.dispatchEvent(u("ps-" + l + "-reach-" + t.reach[l]));
      })(t, i, o, n, s);
    }
    function p(t) {
      ...
      (t.containerWidth = i(o.width)),
        ...
        t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
          ? ((t.scrollbarXActive = !0),
            ...
            (t.scrollbarXWidth = m(
              t,
              p((t.railXWidth * t.containerWidth) / t.contentWidth)
            )),
            (t.scrollbarXLeft = p(
        ...
        t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
          ? ((t.scrollbarYActive = !0),
            ...
            (t.scrollbarYHeight = m(
              t,
              p((t.railYHeight * t.containerHeight) / t.contentHeight)
            )),
            (t.scrollbarYTop = p(
        ...
        v(n, t),
        t.scrollbarXActive
          ? n.classList.add(y.state.active("x"))
          : (n.classList.remove(y.state.active("x")),
            (t.scrollbarXWidth = 0),
            (t.scrollbarXLeft = 0),
            (n.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
        t.scrollbarYActive
          ? n.classList.add(y.state.active("y"))
          : (n.classList.remove(y.state.active("y")),
    ...
    function m(t, e) {
      ...
      return (
        t.settings.minScrollbarLength &&
          (e = n(e, t.settings.minScrollbarLength)),
    ...
    function _(t, e) {
      ...
      function n() {
        h(t, f),
          t[m].classList.remove(y.state.clicking),
    ...
    (k.prototype.eventElement = function (t) {
      ...
      (k.prototype.bind = function (t, e, i) {
        this.eventElement(t).bind(e, i);
      }),
      (k.prototype.unbind = function (t, e, i) {
      ...
      (k.prototype.once = function (t, e, i) {
        var n = this.eventElement(t),
          s = function (t) {
            n.unbind(e, s), i(t);
          };
      ...
      D = {
              ...
              (t.settings.suppressScrollX && 0 !== a) ||
                ...
                (function (n, s) {
                  ...
                  if (0 === n) {
                    ...
                    if (
                      (0 === o && 0 < s) ||
                      (o >= t.contentHeight - t.containerHeight && 0 > s)
                    )
                  ...
                  if (0 === s) {
                    ...
                    if (
                      (0 === r && 0 > n) ||
                      (r >= t.contentWidth - t.containerWidth && 0 < n)
                    )
                      return !t.settings.wheelPropagation;
                  }
                  return !0;
        ...
        wheel: function (n) {
          function s(t, e, n) {
            ...
            for (var s = t; s && s !== r; ) {
              ...
              if (n && o.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < s.scrollTop && 0 > n) || (s.scrollTop < a && 0 < n))
                )
                  return !0;
              }
              if (e && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < l &&
                  ((0 < s.scrollLeft && 0 > e) || (s.scrollLeft < l && 0 < e))
                )
                  return !0;
              }
              s = s.parentNode;
            ...
            if (!s(i.target, a, l)) {
              ...
              n.settings.useBothWheelAxes
                ? n.scrollbarYActive && !n.scrollbarXActive
                  ? (l
                      ? (r.scrollTop -= l * n.settings.wheelSpeed)
                      : (r.scrollTop += a * n.settings.wheelSpeed),
                    (h = !0))
                  : n.scrollbarXActive &&
                    !n.scrollbarYActive &&
                    (a
                      ? (r.scrollLeft += a * n.settings.wheelSpeed)
                      : (r.scrollLeft -= l * n.settings.wheelSpeed),
                    (h = !0))
                : ((r.scrollTop -= l * n.settings.wheelSpeed),
                  (r.scrollLeft += a * n.settings.wheelSpeed)),
                g(n),
          ...
          void 0 === window.onwheel
            ? void 0 !== window.onmousewheel && n.event.bind(r, "mousewheel", o)
            : n.event.bind(r, "wheel", o);
        },
        touch: function (n) {
          function s(i, s) {
            var o = e(d.scrollTop),
            ...
            if (l > a) {
              if (
                (0 > s && o === n.contentHeight - n.containerHeight) ||
                (0 < s && 0 === o)
              )
                return 0 === window.scrollY && 0 < s && T.isChrome;
            } else if (
              a > l &&
              ((0 > i && r === n.contentWidth - n.containerWidth) ||
                (0 < i && 0 === r))
            )
              return !0;
            return !0;
          ...
          function h(t, e, n) {
            ...
            for (var s = t; s && s !== d; ) {
              ...
              if (n && o.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < r &&
                  ((0 < s.scrollTop && 0 > n) || (s.scrollTop < r && 0 < n))
                )
                  return !0;
              }
              if (e && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < s.scrollLeft && 0 > e) || (s.scrollLeft < a && 0 < e))
                )
                  return !0;
              }
              s = s.parentNode;
          ...
          function c(t) {
            if (a(t)) {
              ...
              var c = new Date().getTime(),
                u = c - f;
              0 < u && ((m.x = n / u), (m.y = l / u), (f = c)),
                s(n, l) && t.preventDefault();
            }
          }
          function u() {
          ...
          if (T.supportsTouch || T.supportsIePointer) {
            var d = n.element,
              ...
              v = null;
            T.supportsTouch
              ? (n.event.bind(d, "touchstart", l),
                n.event.bind(d, "touchmove", c),
                n.event.bind(d, "touchend", u))
              : T.supportsIePointer &&
                (window.PointerEvent
                  ? (n.event.bind(d, "pointerdown", l),
                    n.event.bind(d, "pointermove", c),
                    n.event.bind(d, "pointerup", u))
                  : window.MSPointerEvent &&
                    (n.event.bind(d, "MSPointerDown", l),
                    n.event.bind(d, "MSPointerMove", c),
                    n.event.bind(d, "MSPointerUp", u)));
          }
        },
      },
      E = function (t, o) {
        ...
        (this.isRtl = "rtl" === i(t).direction),
          ...
          (this.isNegativeScroll = (function () {
            var e,
              i = t.scrollLeft;
            return (
              (t.scrollLeft = -1), (e = 0 > t.scrollLeft), (t.scrollLeft = i), e
            );
          })()),
        ...
        (this.scrollbarXBottom = parseInt(c.bottom, 10)),
          isNaN(this.scrollbarXBottom)
            ? ((this.isScrollbarXUsingBottom = !1),
              (this.scrollbarXTop = p(c.top)))
            : (this.isScrollbarXUsingBottom = !0),
          (this.railBorderXWidth =
            p(c.borderLeftWidth) + p(c.borderRightWidth)),
        ...
        (this.scrollbarYRight = parseInt(u.right, 10)),
          ...
          (this.railBorderYWidth =
            p(u.borderTopWidth) + p(u.borderBottomWidth)),
      ...
      (E.prototype.update = function () {
        this.isAlive &&
          ...
          (this.railXMarginWidth =
            p(i(this.scrollbarXRail).marginLeft) +
            p(i(this.scrollbarXRail).marginRight)),
          (this.railYMarginHeight =
            p(i(this.scrollbarYRail).marginTop) +
            p(i(this.scrollbarYRail).marginBottom)),
